...
function setup() {
    ...
    result = createElement('p', "'The Day the Music Died' refers to the tragic deaths of which artists?");
...
function output() {
  ...
  if (answers == "Buddy Holly"){
    background(201, 245, 191);
    // Answer1.innerHTML = answers;
    let a = createA('page4.html', 'next question');
    a.id('next');
    colorInput.appendChild(next);
  } 
    else if (answers == "Ritchie Valens"){
      background(201, 245, 191);
    // Answer1.innerHTML = answers;
    let a = createA('page4.html', 'next question');
    a.id('next');
    ...
    else if (answers == "The Big Bopper"){
      background(201, 245, 191);
    // Answer1.innerHTML = answers;
    let a = createA('page4.html', 'next question');
    a.id('next');
